...
const CourseContentMedia = ({
  ...
  const isReviewed = courseData?.course?.reviews?.find(
  ...
  return (
    <div className="w-[95%] md:w-[86%] py-4 m-auto text-black dark:text-white">
      <CoursePlayer
        title={data[activeVideo]?.title}
        videoUrl={data[activeVideo]?.videoUrl}
      />

      <div className="w-full flex items-center justify-between my-3 text-black dark:text-white">
        <div
      ...
      <div className="w-full p-4 flex items-center justify-between text-black dark:text-white bg-slate-400 bg-opacity-20 backdrop-blur shadow-[bg-slate-700] rounded mb-1">
      ...
      {activeBar === 0 && (
        <p className="text-[18px] text-black dark:text-white whitespace-pre-line mb-3 text-justify">
        ...
        <>
          <div className="flex w-full">
            ...
            <textarea
              ...
              className="outline-1 bg-transparent ml-3 border border-[#ffffff57] md:w-full p-2 rounded w-[90%] md:text-[18px] font-Poppins dark:text-white text-black resize-none overflow-y-auto overflow-x-hidden"
            ></textarea>
          </div>
          ...
          <div className="w-full flex justify-end mb-3">
            <div
              className={`${
                ...
                (questionCreationLoading || !question.trim()) &&
                "cursor-no-drop bg-gray-400"
              }`}
              onClick={handleQuestionSubmit}
              aria-disabled={questionCreationLoading || !question.trim()}
            >
              Submit
            </div>
          </div>
              ...
              <>
                <div className="flex w-full">
                  ...
                  <div className="w-full">
                    ...
                    <textarea
                      ...
                      className="outline-none bg-transparent ml-3 border border-[#ffffff57] md:w-full p-2 rounded w-[90%] md:text-[18px] font-Poppins dark:text-white text-black resize-none"
                    ></textarea>
                  </div>
                </div>
                <div className="w-full flex justify-end">
                  <div
                    className={`${
                      styles.button
                    } !w-[120px] !h-[40px] text-[18px] mt-5 mr-2 md:mr-0 ${
                      (reviewMessage.trim() === "" || reviewCreationLoading) &&
                      "cursor-no-drop"
                    }`}
                    onClick={handleReviewSubmit}
                    aria-disabled={reviewCreationLoading}
                  >
                    Submit
                  </div>
                </div>
              ...
              {(
                ...
                >
                  ...
                  {isReviewReply && reviewId === review?._id && (
                    <div className="w-full flex relative dark:text-white text-black ">
                      <input
                        ...
                        className={`block md:ml-12 mt-2 text-black dark:text-white outline-none dark:border-white bg-transparent border-b border-[#00000027] p-[5px] w-[95%] ${
                  ...
                  {review?.commentReplies?.map((reply: any, index: number) => (
                    <div className="w-full flex md:ml-[16px] my-5 " key={index}>
                      <div className="w-[50px] h-[50px]">
                        <Image
                          src={
                            reply?.user.avatar
