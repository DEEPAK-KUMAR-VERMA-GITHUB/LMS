...
const ChangePassword: FC = () => {
  ...
  return (
    <div className=" w-full pl-7 px-2 md:px-5 md:pl-0 dark:text-white text-black">
      <h1 className="block text-[25px] md:text-[30px] font-Poppins text-center font-[500] dark:text-white text-black pb-2 ">
        Change Password
      </h1>
      <div className="w-full">
        ...
        >
          ...
          <input
            type="submit"
            value="Update"
            className={`w-full md:w-[250px] h-[40px] border border-[#37a39a] text-center dark:text-white text-black rounded-[3px] mt-8 cursor-pointer`}
          />
        </form>
      </div>
    </div>
